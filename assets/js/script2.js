...
function callMenu() {
    ...
    $("#menu ul li a").off().click(function(event){ //keitka fungsi ini di klik dia akan off terlebih dahulu kemudian diizinkan kembali sehingga dapat menjalankan fungis didalamnya
